  ...
  return (
    <div className="text-center py-16">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
        ...
        <div
          className="bg-white p-6 rounded-lg shadow-md card-hover animate-fadeIn"
          style={{ animationDelay: "0.1s" }}
        >
          <div className="text-3xl mb-3">🔒</div>
          <h3 className="text-xl font-semibold mb-2">Pago Seguro</h3>
          <p className="text-gray-600">Protección en todas tus compras</p>
        </div>
        <div
          className="bg-white p-6 rounded-lg shadow-md card-hover animate-fadeIn"
        ...
        >
          ...
          <p className="text-gray-600">Productos verificados y de calidad</p>
        </div>
      </div>
    </div>
  );
